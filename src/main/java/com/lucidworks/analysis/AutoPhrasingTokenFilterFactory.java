...
public class AutoPhrasingTokenFilterFactory extends TokenFilterFactory implements ResourceLoaderAware {
    ...
    public TokenStream create(TokenStream input) {
        AutoPhrasingTokenFilter autoPhraseFilter = new AutoPhrasingTokenFilterBuilder().setInput(input).setPhraseSet(phraseSets).setEmitSingleTokens(emitSingleTokens).createAutoPhrasingTokenFilter();
